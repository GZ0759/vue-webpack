      ...
      >
        <div class="subForm people">
          ...
          <el-form-item label="信息员姓名" prop="IONAME">
            <el-input v-model="forms.IONAME" placeholder="必填"></el-input>
          </el-form-item>
          ...
          <el-form-item label="政治面貌" prop="POLITICAL_STATUS">
            <el-input v-model="forms.POLITICAL_STATUS" placeholder="必填"></el-input>
          </el-form-item>
          <el-form-item label="民族" prop="NATIONALITY">
            <el-input v-model="forms.NATIONALITY" placeholder="必填"></el-input>
          </el-form-item>
          <el-form-item label="手机号码" prop="PNUM">
            <el-input v-model="forms.PNUM" placeholder="必填"></el-input>
          </el-form-item>
          ...
          <el-form-item label="家庭住址" prop="ADDRESS">
            <el-input v-model="forms.ADDRESS" placeholder="必填"></el-input>
          </el-form-item>
          ...
          <el-form-item label="日常主要使用语言" prop="DAILY_LANGUAGE">
            <el-input v-model="forms.DAILY_LANGUAGE" placeholder="必填"></el-input>
          </el-form-item>
          ...
          <el-form-item label="任职单位及职务" prop="POSITION">
            <el-input v-model="forms.POSITION" placeholder="必填"></el-input>
          </el-form-item>
          ...
          <el-form-item label="所获荣誉及证书" prop="HONORS_AND_CERTIFICATES">
            <el-input v-model="forms.HONORS_AND_CERTIFICATES" placeholder="必填"></el-input>
          </el-form-item>
          <!-- </el-form> -->
        </div>
        <div class="subForm baseDoc">
          ...
          <el-form-item label="地址" prop="PROVINCE">
            ...
            <el-select v-model="forms.CITY" placeholder="市" @change="init(3)">
              <el-option
            ...
            <el-select v-model="forms.COUNTY" placeholder="县（市、区）">
              <el-option
            ...
            <el-select v-model="forms.TOWN" placeholder="镇（乡）">
              <el-option
                v-for="item in towns"
                :key="item.xzqy_id"
                :label="item.zhen"
          ...
          <el-form-item label="运营主体名称" prop="OPERATION_NAME">
            <el-input v-model="forms.OPERATION_NAME" placeholder="必填"></el-input>
          </el-form-item>
          ...
          <el-form-item label="村总人口（人）" prop="TOL_POPULATION" placeholder="必填">
            <el-input v-model.number="forms.TOL_POPULATION" type="number">
          ...
          <el-form-item label="村基础设施情况（单选）" prop="VILLAGE_INFRASTRURE">
            <el-radio-group v-model="forms.VILLAGE_INFRASTRURE">
          ...
          <el-form-item label="营业执照编号（或登记证书编号、组织机构代码）" prop="BLNUM">
            <el-input v-model="forms.BLNUM" placeholder="必填"></el-input>
          </el-form-item>
        ...
        <div class="subForm situation">
          ...
          <!-- <el-form :model="forms" :rules="rules" ref="ruleForm2"> -->
          <el-form-item label="当地特色农场品名称" prop="SPECIALTY_NAME">
            <el-input v-model="forms.SPECIALTY_NAME" placeholder="必填"></el-input>
          </el-form-item>
        ...
        <div class="subForm site">
          ...
          <!-- <el-form :model="forms" :rules="rules" ref="ruleForm2"> -->
          <el-form-item label="可安装门头的最大尺寸" prop="DOOR_MAX_SIZE">
            <el-input v-model="forms.DOOR_MAX_SIZE" placeholder="必填"></el-input>
          </el-form-item>
          ...
          <el-form-item label="可放置货架的最大空间（长*宽*高）" prop="MAX_ROOM">
            <el-input v-model="forms.MAX_ROOM" placeholder="必填"></el-input>
          </el-form-item>
          ...
          <el-form-item label="经纬度" prop="LATITUDE_LONGITUDE">
            <el-input v-model="forms.LATITUDE_LONGITUDE" placeholder="必填"></el-input>
          </el-form-item>
        ...
        <div class="subForm evaluate">
          ...
          <!-- <el-form :model="forms" :rules="rules" ref="ruleForm2"> -->
          <el-form-item prop="INITIAL_ASSESS">
            <el-input
              placeholder="必填"
              v-model="forms.INITIAL_ASSESS"
              type="textarea"
              :autosize="{ minRows: 2}"
            ></el-input>
          </el-form-item>
        ...
        <div class="subForm other">
          ...
          <el-form-item>
            <el-input
              placeholder="选填"
              v-model="forms.OTHER_CIRCUMSTANCES"
              type="textarea"
              :autosize="{ minRows: 2}"
            ></el-input>
          </el-form-item>
        ...
        <div class="subForm investigator">
          ...
          <el-form-item label="考察人" prop="INVESTIGATOR">
            <el-input placeholder="必填" v-model="forms.INVESTIGATOR"></el-input>
          </el-form-item>
          <el-form-item label="考察日期" prop="INVESTIGATE_DATE">
            <el-date-picker
              v-model="forms.INVESTIGATE_DATE"
              type="date"
              placeholder="选择日期"
